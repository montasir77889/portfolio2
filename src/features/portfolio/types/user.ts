...
export type User = {
  ...
  displayName: string
  /** Name shown in the big cover/spotlight effect (can differ from displayName) */
  coverName: string
  ...
  /** WhatsApp number (can differ from phoneNumberB64), E.164 format, base64 encoded */
  whatsappNumberB64: string
