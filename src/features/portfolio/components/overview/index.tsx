  ...
  return (
    <Panel className="screen-line-bottom-none">
      ...
      <PanelContent className="grid gap-x-4 gap-y-2.5 sm:grid-cols-2">
        ...
        <IntroItem>
          <IntroItemIcon className="border-rose-500/20 bg-rose-500/10 text-rose-600 ring-rose-500/20 dark:text-rose-400">
            <MapPinIcon />
          </IntroItemIcon>
          <IntroItemContent>
            <IntroItemLink
        ...
        <IntroItem>
          <IntroItemIcon className="border-pink-500/20 bg-pink-500/10 text-pink-600 ring-pink-500/20 dark:text-pink-400">
